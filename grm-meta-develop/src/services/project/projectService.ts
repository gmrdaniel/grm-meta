...
export const fetchProjects = async (): Promise<Project[]> => {
  ...
  const projects = data.map((project) => ({
    ...
    platforms: Array.isArray(project.project_social_media_platforms)
      ? project.project_social_media_platforms.map(
 ...
 * Update stages order
 */
export const updateStagesOrder = async (
  stages: Array<{ id: string; order_index: number }>
): Promise<void> => {
