...
export function MetaTermsAndConditions() {
          ...
          <ol className="list-decimal list-inside space-y-3">
            <li>
              ...
              <p className="mt-2 text-justify">
                ...
                benefits, payment details, timelines, and terms of participation
                are subject to change by Meta at any time.
              </p>
              <p className="mt-2 text-justify">
                Global Media Review Inc. (our agency) is not responsible for any
                changes, adjustments, missing payments, or modifications in
                program terms made by Meta. Meta reserves the right to change or
                discontinue benefits without prior notice. We (the agency)
            ...
            <li>
              ...
              <p className="mt-2 text-justify">
                By completing this onboarding form, you explicitly authorize and
                grant us (the agency) permission to contact you directly via:
              </p>
              ...
              <p className="mt-2 text-justify">
                You further authorize us to share your provided information with
                trusted third-party partners and brands for the purpose of
            ...
            <li>
              ...
              <ul className="list-disc list-inside pl-4 mt-4">
                ...
                <li className="mt-2 text-justify">
                  ...
                  guidance purposes only and do not guarantee audience growth or
                  monetization results.
                </li>
              </ul>
              <p className="mt-4 text-justify">
                We (the agency) explicitly disclaim liability for any claims,
                disputes, copyright infringement, or legal consequences related
                to your content.
              </p>
            </li>
            <li>
              ...
              <ul className="list-disc list-inside pl-4 mt-4">
                ...
                <li className="mt-2">
                  Update or modify eligibility criteria, terms, and conditions,
                  or any aspect of the onboarding process by providing notice
                  via email or SMS.
                </li>
              </ul>
            </li>
      ...
      >
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogTrigger asChild>
            <button
              type="button"
              className={`text-purple-600 hover:underline p-0 m-0 bg-transparent inline`}
            >
