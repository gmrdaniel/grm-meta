...
export const PinterestVerificationSuccess = () => {
  ...
  return (
    <CardContent className="space-y-6 text-center py-12">
      <h2 className="text-3xl font-bold bg-gradient-to-r from-rose-600 to-blue-600 bg-clip-text text-transparent mb-6">
      ...
      <Button
        ...
        className="w-full bg-gradient-to-r from-rose-600 to-blue-600 hover:from-rose-700 hover:to-blue-700 text-white text-lg py-6 h-auto"
      >
