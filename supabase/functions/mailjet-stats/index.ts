...
serve(async (req) => {
  ...
  try {
    // Ejemplo: Obtener estadísticas de todas las campañas
    const response = await fetch("https://api.mailjet.com/v3/REST/campaignstatistics?Limit=10&Sort=CreatedAt+DESC", {
      method: "GET",
      headers: {
